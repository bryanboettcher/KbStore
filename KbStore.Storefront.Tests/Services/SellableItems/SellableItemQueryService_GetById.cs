...
public abstract class SellableItemQueryService_GetById : QueryService_Tests<SellableItemQueryService>
{
    ...
    {
        Result = await Subject.GetByIdAsync(SellableItemId);
    }

    public class When_getting_by_id_found : SellableItemQueryService_GetById
    {
        protected override void Arrange()
        {
            base.Arrange();
    ...
    public class When_getting_by_id_not_found : SellableItemQueryService_GetById
    {
        protected override void Arrange()
        {
            base.Arrange();
