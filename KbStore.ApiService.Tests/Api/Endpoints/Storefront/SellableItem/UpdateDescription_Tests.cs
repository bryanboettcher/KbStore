...
public abstract class UpdateDescription_Tests : SellableItemEndpoints_Tests
{
    protected static readonly Guid TestId = Guid.NewGuid();
    protected static readonly UpdateDescriptionPayload ValidPayload = new() { Description = "Updated description" };
    protected static readonly UpdateDescriptionPayload NullDescriptionPayload = new() { Description = null };
    ...
    public class When_updating_successfully : UpdateDescription_Tests
    {
        ...
        protected override async Task Act()
            => Output = await Execute(SellableItemEndpoints.UpdateDescription, TestId, ValidPayload);
    ...
    public class When_clearing_description : UpdateDescription_Tests
    {
        protected override void Arrange()
        {
            MockOf<ISellableItemCommandService>()
        ...
        protected override async Task Act()
            => Output = await Execute(SellableItemEndpoints.UpdateDescription, TestId, NullDescriptionPayload);
