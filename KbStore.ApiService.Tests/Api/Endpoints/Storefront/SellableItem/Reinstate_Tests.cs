...
public abstract class Reinstate_Tests : SellableItemEndpoints_Tests
{
    protected static readonly Guid TestId = Guid.NewGuid();

    public class When_reinstating_successfully : Reinstate_Tests
    {
        protected override void Arrange()
        {
            MockOf<ISellableItemCommandService>()
                .ReinstateAsync(TestId, Arg.Any<CancellationToken>())
        ...
        protected override async Task Act()
            => Output = await Execute(SellableItemEndpoints.Reinstate, TestId);
    ...
    public class When_service_throws_exception : Reinstate_Tests
    {
        protected override void Arrange()
        {
            MockOf<ISellableItemCommandService>()
