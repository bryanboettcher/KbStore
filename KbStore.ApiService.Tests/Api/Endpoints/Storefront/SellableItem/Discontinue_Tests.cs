...
public abstract class Discontinue_Tests : SellableItemEndpoints_Tests
{
    protected static readonly Guid TestId = Guid.NewGuid();

    public class When_discontinuing_successfully : Discontinue_Tests
    {
        protected override void Arrange()
        {
            MockOf<ISellableItemCommandService>()
                .DiscontinueAsync(TestId, Arg.Any<CancellationToken>())
        ...
        protected override async Task Act()
            => Output = await Execute(SellableItemEndpoints.Discontinue, TestId);
    ...
    public class When_service_throws_exception : Discontinue_Tests
    {
        protected override void Arrange()
        {
            MockOf<ISellableItemCommandService>()
