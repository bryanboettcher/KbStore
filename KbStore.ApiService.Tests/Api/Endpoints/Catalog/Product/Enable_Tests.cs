...
public abstract class Enable_Tests : ProductEndpoints_Tests
{
    ...
    public class When_enabling_successfully : Enable_Tests
    {
        protected override void Arrange()
        {
            MockOf<IProductCommandService>()
                .EnableAsync(TestId, Arg.Any<CancellationToken>())
        ...
        protected override async Task Act()
            => Output = await Execute(ProductEndpoints.Enable, TestId);
    ...
    public class When_service_throws_exception : Enable_Tests
    {
        protected override void Arrange()
        {
            MockOf<IProductCommandService>()
