...
public abstract class UpdateInventoryQuantity_Tests : Endpoint_Tests<UpdateInventoryQuantityRequest>
{
    protected static readonly Guid TestId = Guid.NewGuid();
    protected static readonly int ValidQuantity = 500;

    public class When_updating_successfully : UpdateInventoryQuantity_Tests
    {
        protected override void Arrange()
            => RespondWith<UpdateInventoryResponse>(new { });

        protected override async Task Act()
            => Output = await Execute(InventoryEndpoints.UpdateQuantity, TestId, ValidQuantity);
    ...
    public class When_quantity_is_negative : UpdateInventoryQuantity_Tests
    {
        protected override void Arrange()
            => ResponseUnexpected();

        protected override async Task Act()
            => Output = await Execute(InventoryEndpoints.UpdateQuantity, TestId, -1);
    ...
    public class When_quantity_is_zero : UpdateInventoryQuantity_Tests
    {
        protected override void Arrange()
            => RespondWith<UpdateInventoryResponse>(new { });

        protected override async Task Act()
            => Output = await Execute(InventoryEndpoints.UpdateQuantity, TestId, 0);
    ...
    public class When_inventory_is_missing : UpdateInventoryQuantity_Tests
    {
        protected override void Arrange() =>
    ...
    public class When_backend_returns_unexpected_response : UpdateInventoryQuantity_Tests
    {
